...
Spec basis: `specs/BGA_PRIMER.md` §4 (clienttranslate rule), `specs/CONTRACT.md` §2 (notification log_message templates), BGA Studio docs ("Tools for translators": clienttranslate / self::_() / totranslate / `_()` JS / `$this->_()`).
