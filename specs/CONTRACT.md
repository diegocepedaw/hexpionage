...
>
> **Scope**: data shapes only. State-machine transitions live in `specs/STATE_MACHINE.md`; storage in `specs/STATE_MODEL.md`; UI rendering in `specs/UI_SPEC.md`.
>
> **Source-of-truth dependency order**: `rulebook.md` → `DECISIONS.md` → `specs/STATE_MODEL.md` → `specs/STATE_MACHINE.md` → `specs/UI_SPEC.md` → this doc.
>
...
type GetAllDatas = {
  ...
  // rather than hard-coding coordinates. Source-of-truth: assets/BOARD_LAYOUT.md.
  board_layout: {
