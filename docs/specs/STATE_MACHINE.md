...
>
> **Source-of-truth dependency order**: `rulebook.md` → `DECISIONS.md` → `docs/specs/STATE_MODEL.md` → `docs/specs/BGA_PRIMER.md` → this doc. Citations inline as `§N.N` (rulebook), `[D-NN]` (decisions), `STATE_MODEL §N` (state model doc), `BGA_PRIMER §N` (primer doc).
>
