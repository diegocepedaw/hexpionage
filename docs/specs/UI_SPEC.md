...
>
> **Inputs**: `rulebook.md`, `DECISIONS.md`, `docs/specs/STATE_MACHINE.md`, `design/MANIFEST.md`, `design/MISSING.md`, `docs/specs/BGA_PRIMER.md` §6/§7, `docs/specs/STATE_MODEL.md` §3. **Out of scope**: CSS/JS source (A8), notification schema (A11), sprite pixel coordinates (asset pipeline).
>
